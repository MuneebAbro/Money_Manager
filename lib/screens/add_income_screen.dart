...
class _AddIncomeScreenState extends State<AddIncomeScreen> {
  ...
  final List<Map<String, dynamic>> _categories = [
    {'label': 'Salary',     'icon': Icons.work_rounded,           'color': const Color(0xFF34C759)},
    {'label': 'Freelance',  'icon': Icons.laptop_mac_rounded,     'color': const Color(0xFF5AC8FA)},
    {'label': 'Gift',       'icon': Icons.card_giftcard_rounded,  'color': const Color(0xFFFF2D55)},
    {'label': 'Investment', 'icon': Icons.trending_up_rounded,    'color': const Color(0xFF00D2A0)},
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(hintText: 'e.g. Monthly Salary', prefixIcon: Icon(Icons.edit_note_rounded)),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text('Save Income', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildHeader() {
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [Color(0xFF00B488), Color(0xFF00D2A0)], begin: Alignment.topLeft, end: Alignment.bottomRight),
            ...
            children: [
              ...
              Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Add Income', style: GoogleFonts.inter(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
                  Text('Record your earnings', style: GoogleFonts.inter(color: Colors.white70, fontSize: 13)),
                ]),
              ]),
            ],
          ),
